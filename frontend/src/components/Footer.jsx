  ...
  return (
    <div className='bg-white border-t border-gray-100 mt-32'>
      <div className='container-custom flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-16 text-sm'>
        ...
        <div>
            <h2 className='text-xl font-serif mb-5 uppercase tracking-wider'>Urban Loom</h2>
        ...
        <div>
            ...
            <ul className='flex flex-col gap-2 text-gray-600 font-light'>
                <li className='hover:text-black cursor-pointer transition-colors'>+91 9146224887</li>
                <li className='hover:text-black cursor-pointer transition-colors'>vaibhavpatil090604@gmail.com</li>
            </ul>
        </div>
      ...
      <div className='container-custom'>
          ...
          <p className='py-5 text-xs text-center text-gray-400 font-light'>Copyright 2025@ urbanloom.com - All Right Reserved.</p>
      </div>
    </div>
  )
}
