  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' placeholder='Email address' type="email" />
        ...
        <div className='flex gap-3'>
          <input className='[&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [appearance:textfield] border border-gray-500 rounded py-1.5 px-3.5 w-full' placeholder='Zip / Postal Code' type="number" />
          <input className='border border-gray-500 rounded py-1.5 px-3.5 w-full' placeholder='Country' type="text" />
        </div>
        <input className='[&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [appearance:textfield] border border-gray-500 rounded py-1.5 px-3.5 w-full' placeholder='Phone' type="number" />
      </div>
